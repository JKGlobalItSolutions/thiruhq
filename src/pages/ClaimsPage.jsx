...
import { FileText, Clock, CheckCircle, Phone, ArrowRight, ShieldCheck, Heart, Zap, Headphones, Activity } from "lucide-react";
import { Button } from "@/components/ui/button";

const CLAIM_CARDS = [
  { icon: FileText, title: "File a New Claim", desc: "Submit your insurance claim online with our simple, step-by-step process. Get approval in minutes.", link: "/support/claim-assistance" },
  ...
  { icon: CheckCircle, title: "Fast Settlement", desc: "Most claims settled within 24-48 hours. Quick, transparent, and hassle-free process.", link: "/support/claim-assistance" },
];
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              ...
              <div className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-4 py-1.5 text-xs font-semibold text-white/90 backdrop-blur-sm mb-6">
                <Activity className="h-3.5 w-3.5 text-[#FFCD48]" />
              ...
              <p className="mt-5 max-w-xl text-base md:text-lg text-gray-300 leading-relaxed">
                File, track, and manage your insurance claims with ease. Our dedicated claims team ensures quick processing, transparent updates, and fast settlements.
              </p>

              {/* Feature Chips */}
              <div className="mt-8 flex flex-wrap gap-3">
                <span className="inline-flex items-center gap-1.5 rounded-xl border border-white/15 bg-white/10 px-4 py-2 text-xs sm:text-sm font-medium text-white/90 backdrop-blur-sm">
                  <Zap className="h-3.5 w-3.5 text-[#FFCD48]" />
                  Quick Claim Filing
                </span>
                <span className="inline-flex items-center gap-1.5 rounded-xl border border-white/15 bg-white/10 px-4 py-2 text-xs sm:text-sm font-medium text-white/90 backdrop-blur-sm">
                  <Activity className="h-3.5 w-3.5 text-[#FFCD48]" />
              ...
              <div className="relative">
                ...
                <div className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm p-8">
                  <div className="grid grid-cols-2 gap-4">
                    {[
                      { value: "500K+", label: "Claims Processed", icon: FileText },
                      { value: "98%", label: "Customer Satisfaction", icon: Heart },
                      { value: "24-48", label: "Hour Settlement", icon: Clock },
                      { value: "24/7", label: "Claims Assistance", icon: Headphones },
                    ].map((stat, i) => (
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-sm font-bold text-[#14204A]">within 24 hours</div>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-sm font-bold text-[#14204A]">Claim Tracking</div>
                  </div>
                </motion.div>
